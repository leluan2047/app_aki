...
namespace DoctrineProxy\__CG__\Plugin\Maker\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Maker extends \Plugin\Maker\Entity\Maker implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'id', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'name', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'rank', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'del_flg', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Maker\\Entity\\Maker' . "\0" . 'update_date');
        }
