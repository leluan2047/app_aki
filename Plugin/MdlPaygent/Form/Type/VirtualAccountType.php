...
class VirtualAccountType extends AbstractType {
	private $app;
	private $subData;
	...
	{
		$builder
                ->add('billing_family_name', 'text', array(
                		'required' => false,
                		'attr' => array(
                				'maxlength' => '6',
                				'placeholder' =>'姓',
                		),
                		'data' => $this->subData['billing_family_name'],
                		'constraints' => array(
                ...
                ->add('billing_family_name_kana', 'text', array(
                		...
                		'data' => $this->subData['billing_family_name_kana'],
                		'constraints' => array(
                ...
                ->add('billing_name_kana', 'text', array(
                		'required' => false,
                		'attr' => array(
                				'maxlength' => '12',
                				'placeholder' =>'メイ',
                		),
                		'data' => $this->subData['billing_name_kana'],
                		'constraints' => array(
