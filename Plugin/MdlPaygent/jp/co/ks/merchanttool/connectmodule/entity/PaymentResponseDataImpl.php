...
class PaymentResponseDataImpl extends ResponseData {
	...
	function parse($body) {
		...
		$PaymentResponseDataImpl__LINE_SEPARATOR = $this->app['config']['MdlPaygent']['const']['PaymentResponseDataImpl__LINE_SEPARATOR'];
		$PaymentResponseDataImpl__PROPERTIES_REGEX = $this->app['config']['MdlPaygent']['const']['PaymentResponseDataImpl__PROPERTIES_REGEX'];
		$PaymentResponseDataImpl__PROPERTIES_REGEX_COUNT = $this->app['config']['MdlPaygent']['const']['PaymentResponseDataImpl__PROPERTIES_REGEX_COUNT'];
		$ResponseData__HTML_ITEM = $this->app['config']['MdlPaygent']['const']['ResponseData__HTML_ITEM'];
		$ResponseData__RESULT = $this->app['config']['MdlPaygent']['const']['ResponseData__RESULT'];
		$ResponseData__RESPONSE_CODE = $this->app['config']['MdlPaygent']['const']['ResponseData__RESPONSE_CODE'];
		$ResponseData__RESPONSE_DETAIL = $this->app['config']['MdlPaygent']['const']['ResponseData__RESPONSE_DETAIL'];
		...
		if (StringUtil::isEmpty($this->resultStatus)) {
			$PaygentB2BModuleConnectException__KS_CONNECT_ERROR = $this->app['config']['MdlPaygent']['const']['PaygentB2BModuleConnectException__KS_CONNECT_ERROR'];
