...
class Customer extends \Eccube\Entity\AbstractEntity implements UserInterface
{
    ...
    private $virtual_account_bank_code;
    
    private $virtual_account_branch_code;
    
    private $virtual_account_number;
    ...
    /**
     * $virtual_account_branch_code
     */
    public function getVirtualAccountBranchCode()
    {
    	return $this->virtual_account_branch_code;
    }
    
    public function setVirtualAccountBranchCode($virtual_account_branch_code)
    {
    	$this->virtual_account_branch_code = $virtual_account_branch_code;
    	return $this;
    }
     ...
     */
    public function getVirtualAccountBankCode()
    {
    	return $this->virtual_account_bank_code;
    }
    
    public function setVirtualAccountBankCode($virtual_account_bank_code)
    {
    	$this->virtual_account_bank_code = $virtual_account_bank_code;
    	return $this;
    }
